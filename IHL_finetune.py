...
from IHL_data_module import TextDatasetQA, custom_data_collator
from IHL_dataloader import CustomTrainer
...
def main(cfg):
    ...
    # Only add use_flash_attention_2 if flash attention is enabled
